...
const transitions: Readonly<Record<TaskStatus, readonly TaskStatus[]>> = {
  ...
  RUNNING: ["IMPLEMENTED", "TESTING", "REVIEW", "INTEGRATION_READY", "VALIDATING", "FAIL", "BLOCKED", "HUMAN_REVIEW_REQUIRED"],
  IMPLEMENTED: ["FAIL", "BLOCKED"],
  TESTING: ["REVIEW", "INTEGRATION_READY", "VALIDATING", "FAIL", "BLOCKED"],
  REVIEW: ["INTEGRATION_READY", "PASS", "FAIL", "BLOCKED", "HUMAN_REVIEW_REQUIRED"],
