...
import type { ProblemDetailsV1, QueryResponseV2 } from "../contracts/api-v2";
...
export type QueryAction =
  ...
  | { type: "complete"; requestId: number; response: QueryResponseV2 }
